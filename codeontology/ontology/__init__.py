...
This object holds the ontology schema (classes, properties, constraints) and stores all the RDF triples created
 through the constructors and attributes provided upon loading an ontology.
"""
